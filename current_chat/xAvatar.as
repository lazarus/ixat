...
package {
    ...
    public dynamic class xAvatar extends MovieClip {
        ...
        public function xAvatar(_arg_1:MovieClip, _arg_2:String, _arg_3:String="", _arg_4:*=undefined, _arg_5:*=undefined, _arg_6:*=undefined){
            ...
            _arg_2 = _local_22[0];
            if (_local_20[1]){
                if (((((_local_7))) && (!((todo.Macros["glitter"] == "off"))))){
            ...
            if (!(todo.avs & 1)){
                this.Av.Glitter = (this.Av.Glitter2 = undefined);
            };
            if (!(todo.avs & 2)){
                _local_23 = 0;
            };
			...
			if(_arg_2.toLowerCase().indexOf(".gif") >= 0) {
				//requires shuffle, animate and motion
				if (todo.HasPower(_arg_5, 18) && todo.HasPower(_arg_5, 18) && todo.HasPower(_arg_5, 470)) {
					this.Av.gif = true;
				}
				this.Av.gif = false;//disabled till i fix lag
			}
            ...
            if (_local_15 == -1){
                ...
                if ((((_arg_2.substr(0, 4) == "http")) || ((_arg_2.substr(0, 2) == "//")))){
                    ...
                    this.Av.U1 = todo.cdndomain + '/image.php?url=' + _arg_2;
                    this.Av.St = 1;
                        ...
                        if (this.Av.sm){
							...
							if (!(_local_4.ns = Bin.grab(this.Av.U1))){
								if (this.Av.gif) {
									...
									player.load(new URLRequest(this.Av.U1));
