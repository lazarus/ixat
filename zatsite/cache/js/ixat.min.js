"use strict"; + function(a, b) {
	...
	c.defaults = {
		...
		a.extend(!0, c.defaults, d), c.defaults.smoothScroll || SmoothScroll.destroy(), a('[data-provide~="map"]').length && void 0 === b["google.maps.Map"] && a.getScript("https://maps.googleapis.com/maps/api/js?key=" + c.defaults.googleApiKey + "&callback=ixat.map"), c.defaults.googleAnalyticsId && (! function(a, b, c, d, e, f, g) {
		...
		a("[data-countdown]").each(function() {
			...
			b += '<div class="row gap-items-3">',
				b += a(this).data("days") ? '<div class="col"><h5>%D</h5><small>Day%!D</small></div>' : '',
				b += '<div class="col"><h5>%H</h5><small>Hour%!H</small></div>',
				b += '<div class="col"><h5>%M</h5><small>Minute%!M</small></div>',
				b += '<div class="col"><h5>%S</h5><small>Second%!S</small></div>',
				b += "</div>",
				a(this).hasDataAttr("format") && (b = a(this).data("format")),
				a(this).countdown(a(this).data("countdown")).on("update.countdown", function(c) {
					a(this).html(c.strftime(b))
				}).on("finish.countdown", finishCountdown || function() {});
		})
	}, c.aos = function() {
		AOS.init({
			offset: 220,
