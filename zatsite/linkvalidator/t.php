...
include("/root/Dropbox/iXat/Net/DNS.php");
...
$Good = array('xatspace' => 'com', 'xat' => 'com', 'facebook' => 'com'
				,'xatchats' => 'com','mundoxat' => 'com','trialpay' => 'com','freewebs' => 'com'
				,'xatworld' => 'com', 'xatland' => 'com', 'xatblog' => 'com','iwidgetworld' => 'com','mondoxat' => 'com'
				,'xatziggy' => 'com','xatblogs' => 'com','xatbilgisi' => 'tk','xatbilgisi' => 'com'
				,'xatwebs' => 'com','xatlayouts' => 'com','xatnews' => 'com','xatcommunity' => 'com','xat-itaku'=>'com',
				'xatgens' => 'com','xattrade'=>'com', 'adobe'=>'com','katbri'=>'com','xatrehberi'=>'com','xatstuff'=>'com',
				'xatigna' => 'in','xatclub' => 'com','xattenger' => 'com','xatparty'=>'com','xatsmiley'=>'com','xatcambio'=>'com',
				'xatrockhopper'=>'com','xatteen'=>'com','xatteens'=>'com', 'xatweb'=>'com', 'xatadults'=>'com','xatyardim'=>'com',
				'xathelp'=>'com', 'xat-help'=>'com','planetaxat'=>'com', 'xatblogcu'=>'com','xat-aiuto'=>'com', 'twitter'=>'com'); 				
$Good2 = array('xatblogs' => 'net','mundoxat' => 'net','xatradio' => 'net','xatchats' => 'net','xatblog' => 'net', 'xat' => 'co' );
$Good3 = array('xathelp.ipbfree.com'=>1 ,'xat-aide.e-monsite.com'=>1,'xat-aide.x10.mx'=>1, 'xat.bodixite.com'=>1); // still has phish warning
$Good4 = array('aforumfree.com'=>1,'xatradyo.com'=>1,'xatadults.com '=>1, 'xatmusic.net' => 1, 'xatchatbot.com' => 1, 'xat.mx'=>1); // still has phish warning / 
...
file_put_contents( '/root/dropbox/ixatpy/ixatlinkslog.txt'  , $Page . "\n", FILE_APPEND | LOCK_EX );
...
else if($Good[$s[0]] === $s[1] || $Good2[$s[0]] === $s[1])
{
	...
	$Bad = 1;
else if($domain === "xatpower.azbuz.com")
	$Bad = 0;
...
print_r($res);
		...
		for($n=0; $n<count(); $n++)
		{
			...
			{
				$res[$n] = array('bad'=>-1, 'time'=>time);
				MemObj(0, $get[0])->set($get[0], json_encode($res[0]), 12*3600);
			}	
		}
