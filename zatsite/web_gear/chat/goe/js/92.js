 var Defaults = {'ef':'1','col':'','XX':'','YY':'','SC':'','bk':'1','Opt':''};
var Min = {'ef':'Array','col':'','XX':'-100','YY':'-100','SC':'0','bk':'Array','Opt':'0', 0:0};
var Max = {'XX':'100','YY':'100','SC':'1000','Opt':'3', 0:0};
  
 function changeParent(){
	 //var Txt = opener.document.getElementById('gi_92'); 
	 //Txt.value = v;
	 var o, i, j, idc=0, b=0;
	 for (o in Defaults)
	 {
