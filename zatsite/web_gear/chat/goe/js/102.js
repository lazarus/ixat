 var Defaults = {'ef':'1','bk':'1','col':'','XX':'','YY':'','SC':''};
var Min = {'ef':'Array','bk':'Array','col':'','XX':'-100','YY':'-100','SC':'0', 0:0};
var Max = {'XX':'100','YY':'100','SC':'1000', 0:0};
  
 function changeParent(){
	 //var Txt = opener.document.getElementById('gi_102'); 
	 //Txt.value = v;
	 var o, i, j, idc=0, b=0;
	 for (o in Defaults)
	 {
