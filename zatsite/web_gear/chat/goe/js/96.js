 var Defaults = {'ef':'1','col':'','XX':'','YY':'','SC':'','bk':'1','Opt':'0','Op2':'7','BT':'0','BA':'','GA':''};
var Min = {'ef':'Array','col':'','XX':'-100','YY':'-100','SC':'0','bk':'Array','Opt':'Array','Op2':'Array','BT':'Array','BA':'10','GA':'10', 0:0};
var Max = {'XX':'100','YY':'100','SC':'1000','Opt':'7','Op2':'31','BA':'100','GA':'100', 0:0};
  
 function changeParent(){
	 //var Txt = opener.document.getElementById('gi_96'); 
	 //Txt.value = v;
	 var o, i, j, idc=0, b=0;
	 for (o in Defaults)
	 {
