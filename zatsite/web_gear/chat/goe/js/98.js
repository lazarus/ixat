 var Defaults = {'ef':'1','XX':'','YY':'','SC':'','bk':'1','Opt':'31'};
var Min = {'ef':'Array','XX':'-100','YY':'-100','SC':'0','bk':'Array','Opt':'Array', 0:0};
var Max = {'XX':'100','YY':'100','SC':'1000','Opt':'31', 0:0};
  
 function changeParent(){
	 //var Txt = opener.document.getElementById('gi_98'); 
	 //Txt.value = v;
	 var o, i, j, idc=0, b=0;
	 for (o in Defaults)
	 {
