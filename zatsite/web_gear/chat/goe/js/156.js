 var Defaults = {'ef':'1','XX':'','YY':'','SC':'','bk':'1','GT':'0','col':'','NUM':'','PR':'0'};
var Min = {'ef':'Array','XX':'-100','YY':'-100','SC':'0','bk':'Array','GT':'Array','col':'','NUM':'10','PR':'Array', 0:0};
var Max = {'XX':'100','YY':'100','SC':'1000','NUM':'100', 0:0};
  
 function changeParent(){
	 //var Txt = opener.document.getElementById('gi_156'); 
	 //Txt.value = v;
	 var o, i, j, idc=0, b=0;
	 for (o in Defaults)
	 {
